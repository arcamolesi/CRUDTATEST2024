...
namespace CRUDTATEST2024.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,clienteID,data")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,clienteID,data")] Venda venda)
        {
            if (id != venda.id)
            {
                return NotFound();
